...
class DTUMVSDataset(Dataset):
    def __init__(self, datapath, listfile, mode, nviews, ndepths=192, interval_scale=1.06, random_crop=False, augment=False,
        ...
        self.stage3 = kwargs.get('stage3', False)
    ...
    def __getitem__(self, idx):
        ...
        if getattr(self, 'stage3', False):
            proj_matrices_ms = {
                "stage1": proj_matrices_ms['stage2'],  # 1/4
                "stage2": proj_matrices_ms['stage3'],  # 1/2
                "stage3": proj_matrices_ms['stage4'],  # 1/1
            }
            depth_ms = {
                "stage1": depth_ms['stage2'],
                "stage2": depth_ms['stage3'],
                "stage3": depth_ms['stage4'],
            }
            mask = {
                "stage1": mask['stage2'],
                "stage2": mask['stage3'],
